...
class _UploadPageState extends State<UploadPage> with AutomaticKeepAliveClientMixin<UploadPage>
{
    ...
    return Container(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.shop_rounded, color: Colors.white, size: 200.0,),
            Padding(
    ...
    return showDialog(
      ...
      builder: (con){
        return SimpleDialog(
          ...
          children: [
            SimpleDialogOption(
              child: Text("Capture with Camera", style: TextStyle(color: Colors.blueAccent, )),
  ...
  Future<String> uploadItemImage(nFileImage) async 
  {
    ...
    StorageUploadTask uploadTask = storageReference.child("product_$productId.jpg").putFile(nFileImage);
