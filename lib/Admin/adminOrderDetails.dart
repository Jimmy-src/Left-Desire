                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Align(
                        ...
                        child: Text(
                          "RM " + dataMap[EcommerceApp.totalAmount].toString(),
...
class AdminShippingDetails extends StatelessWidget {
      ...
      children: [
        ...
        Padding(
          ...
          child: Center(
            child: InkWell(
              onTap: (){
                confirmParcelShipped(context, getOrderId);
              },
              child: Container(
                decoration: new BoxDecoration(
                  gradient: new LinearGradient(
  ...
  confirmParcelShipped(BuildContext context, String mOrderId)
  {
